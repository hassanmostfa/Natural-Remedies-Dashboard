   ...
   import { FaBell, FaUpload, FaImage } from 'react-icons/fa6';
         ...
         try {
            ...
            return;
             ...
             const notificationData = {
               ...
               // Only include plan if type is user and plan is not 'all'
               ...(formData.type === 'user' && formData.plan !== 'all' && { plan: formData.plan }),
             };
               ...
               <form onSubmit={handleSubmit}>
                  ...
                  <Box>
                     <VStack spacing="4" align="stretch">
                        ...
                        {/* Plan Selector - Only show for User type */}
                        {formData.type === 'user' && (
                           <FormControl isRequired>
                              <FormLabel color={textColor} fontWeight="600">Target Plan</FormLabel>
                              <Select
                                 value={formData.plan}
